    ...
    <div class="container box-container box-head w3-animate-top">
        <div class="row row-head">
            ...
            <div class="row-head-div-2">
                <button class="button-1 head-button3" onclick="popupOpen('add')"><i class="fa-solid fa-user-nurse"></i>Add Conductor</button>
    ...
    <div class="pop-up-card scrollbar w3-animate-top">
        <div class="pop-up-card-content">
            <div class="container box-container box-head">
                <div class="row row-head">
                    <div class="">
                        <h4 class="heading"><i class="fa-solid fa-user-pilot"></i>Add new conductor</h4>
                    </div>
                    <div class="row-head-div-2">
            ...
            <div class="register-conductor">
                <form enctype="multipart/form-data" id="conductor-form">
                    ...
                    <div class="pop-up-button-div box-container box-head m-b-10">
                        <button type="submit" name="submit" class="button-2 box-shadow">Create Conductor</button>
...
<div class="tms-pop-up" id="view">
    <div class="pop-up-bg" onclick="popupClose('view')"></div>
    <div class="pop-up-card scrollbar w3-animate-top">
        <div class="pop-up-card-content">
            <div class="container box-container box-head">
                <div class="row row-head">
                    <div class="">
                        <h4 class="heading"><i class="fa-solid fa-user-pilot"></i>Conductor Details</h4>
                    </div>
                    <div class="row-head-div-2">
                        <button class="button-1 head-button2" title="close" onclick="popupClose('view')"><i
                                class="fa-solid fa-xmark"></i></button>
                    </div>
                </div>
            </div>
...
<div class="tms-pop-up" id="edit">
    <div class="pop-up-bg" onclick="popupClose('edit')"></div>
    <div class="pop-up-card scrollbar w3-animate-top">
        <div class="pop-up-card-content">
            <div class="container box-container box-head">
                <div class="row row-head">
                    <div class="">
                        <h4 class="heading"><i class="fa-solid fa-user-pilot"></i>Update Conductor Details</h4>
                    </div>
                    <div class="row-head-div-2">
                        <button class="button-1 head-button2" title="close" onclick="popupClose('edit')"><i
                                class="fa-solid fa-xmark"></i></button>
                    </div>
                </div>
            </div>
                            ...
                            <div class="driver-info-right box-container-2 m-b-10">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="infos">
                                            <p class="info-heading">PAN Number</p>
                                            <input type="text" class="input-field m-0" name="pan_no" id="e-pan-no" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="driver-info-right box-container-2 m-b-10">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="infos">
                                            <p class="info-heading">Aadhar card</p>
                                            <a href="" id="e-aadhar-path" class="document-view d-v-2" target="_blank">
                                                <i class="fa-duotone fa-file-invoice"></i>
                                            </a>
                        ...
                        <div class="col-sm-12">
                            <div class="pop-up-button-div box-container-sm m-b-10">
                                <button type="submit" name="submit" class="button-2 box-shadow"
                                    onclick="popupClose('edit')">Update Conductor</button>
                                <button type="button" class="button-3 box-shadow"
                                    onclick="popupClose('edit')">cancel</button>
                            </div>
                        </div>
                        </div>
                    </form>
