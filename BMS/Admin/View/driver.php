        ...
        <div class="admin-modal-content">
            <form enctype="multipart/form-data" id="driver-form">
                <div class="admin-modal-header">
                    <h5 class="admin-modal-title">Add new driver</h5>
    ...
    <div class="admin-container">
        ...
        <div class="admin-modal-content">
            <form enctype="multipart/form-data" id="driver-edit-form">
                <div class="admin-modal-header">
                    <h5 class="admin-modal-title">Edit driver details</h5>
                        ...
                        <div class="row">
                            <div class="col-sm-3 p-r-0 m-b-10">
                                <div class="driver-info-left box-container-2 h-100">
                                    <div class="row">
                                        <div class="col-sm-12 info-profile-image-div">
                                            <img id="edit-d-v-profile-img"
                                                src="../../Assets/Developer/image/manager.png" alt="profile image"
                                                class="info-profile-image-re-upload">
                                        </div>
                                        <div class="col-sm-12">
                                            ...
                                            <div class="info-div">
                                                ...
                                                <div class="infos">
                                                    ...
                                                    <input type="number" class="input-field m-0" name="mobile"
                                                        id="d-e-mobile" required />
                                                </div>
                                                <div class="infos">
                                                    <p class="info-heading">Language</p>
                                                    <select class="input-field m-0" name="language" id="d-e-language" required>
                                ...
                                <div class="driver-info-right box-container-2 m-b-10">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="infos">
                                                <p class="info-heading">Aadhar card</p>
                                                <a href="" id="d-e-aadhar-path" class="document-view d-v-2"
                                                    target="_blank">
                                                    <i class="fa-duotone fa-file-invoice"></i>
                                                </a>
                                                <div class="file-input m-t-20">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="infos">
                                                <p class="info-heading">PAN card</p>
                                                <a href="" id="d-e-pan-path" class="document-view  d-v-3"
                                                    target="_blank">
                                                    <i class="fa-duotone fa-file-invoice"></i>
                                                </a>
                                                <div class="file-input m-t-20">
                ...
                <div class="admin-modal-footer">
                    ...
                    <button type="reset" class="button-2" onclick="popupClose('edit')">cancel</button>
                </div>
            </form>
        </div>
    </div>
