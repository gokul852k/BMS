    ...
    if ($displayTrip['display'] == 'TRIP START') {
        ...
        ?>
            <div class="wrapper center-div">
                <form id="trip-collection" class="car centered p-10">
                    <div class="container box-container w3-animate-bottom">
                        <h5 class="heading center"><?= $tlabels[10]['translation'] ?> - 1</h5>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <input type="number" class="input-field" name="passengers" id="passengers"
                                    placeholder="<?= $tlabels[13]['translation'] ?>">
                                <span class="error-message p-r-l-15" id="passengers-error"></span>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-12">
                                <input type="number" class="input-field" name="collection" id="collection"
                                    placeholder="<?= $tlabels[14]['translation'] ?>">
                                <span class="error-message p-r-l-15" id="collection-error"></span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group button-center">
                                    <button class="button-2" id="submit" name="btn"><?= $tlabels[15]['translation'] ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        if ($displayStartTrip['status'] == 'success') {
            ...
            ?>
                    <div class="wrapper center-div">
                        <form id="trip-collection-2" class="car centered p-10">
                            <div class="container box-container w3-animate-bottom">
                                <h5 class="heading center"><?= $tlabels[10]['translation'] ?> - 2</h5>
                                <input type="hidden" name="trip-id" value="<?= $displayTrip['tripId'] ?>" />
                                <input type="hidden" name="trip-driver-id" value="<?= $displayTrip['tripConductorId'] ?>" />
                                <div class="row selectpicker-row">
                                    <div class="col-sm-12">
                                        <select class="selectpicker input-field" data-show-subtext="true" data-live-search="true"
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="number" class="input-field" name="passengers-2" id="passengers-2"
                                            placeholder="<?= $tlabels[13]['translation'] ?>">
                                        <span class="error-message p-r-l-15" id="passengers-2-error"></span>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="number" class="input-field" name="collection-2" id="collection-2"
                                            placeholder="<?= $tlabels[14]['translation'] ?>">
                                        <span class="error-message p-r-l-15" id="collection-2-error"></span>
                                    </div>
                                </div>
            ...
            ?>
                    <p>Something went wrong. Pleace try agin.</p>
            <?php
        }
    }
} else {
        ...
        <div class="user-modal-content">
            <form id="end-duty">
                ...
                <div class="user-modal-body">
                    ...
                    <div class="user-model-input">
                        ...
                        <label for="" class="input-label">Othere Expence</label>
                            <input type="number" class="input-field" name="othere-expence" id="othere-expence"
                                placeholder="" required>
                            <span class="error-message p-r-l-15" id="othere-expence-error"></span>
                        </div>
                ...
                <div class="user-modal-footer">
                    <button type="submit" class="button-3">End Duty</button>
